const CARDS = [
  ...
  },
  {
    num: "02",
    title: "Filming Day",
    subtitle: "Action! Behind the lens",
    img: "https://lh3.googleusercontent.com/aida-public/AB6AXuAAhetHT8rswzFpn-AHDhTUeTV-Gdf7DJppICG06vGshT5A9X3Q6omn6J_3kkKsvTXp6QwI8WbGVRts9UYCzNP4rbAYXLSRXQoJaZ484hR_-ZQjxIJ58Ch3zLTvdKoj9IjFGjvMWGHI2V0z5IxdigLhmBsN9oHUyAQ53tholSGv4ybKQOu8Hq206bgr-bksclW1a7bCv8foUpY3FP2NmHHItw7v1OPv46WtJJ-9uOsqUc7bxz0CQe-GUQ6GJgZkQkr96UIRNyjUqElN",
    imgH: "h-56",
  ...
  },
  {
    num: "03",
    title: "Brand Launch",
    subtitle: "Pop, clink, cheer",
    img: "https://lh3.googleusercontent.com/aida-public/AB6AXuAsx9C5IjSERqKbMy5eLeUQvT-Jwj6i7o38pNpR660NzxmT0c9oXrthTzUPnuixxiYIIRrE3cTDk9iWVq7jh045nqgWUX5zWi0Pq_3DqHj8MCLs9u1Uqhw-XIvB4I8V5FF99dToF64hlGFuYtnKlM3J7CZbBOFVJLLvGxjPZQt032n9GgrlvBqU-_v_08cIYVJ3Bf051svMv5njzATmvcUE5il5mIgkncqnzjjZl4hCcJ23ciQdv5rk_SMEb80ihbJbtAVZeS0d30cV",
    imgH: "h-40",
  ...
  },
  {
    ...
    subtitle: "Ideas flowing",
    img: "https://lh3.googleusercontent.com/aida-public/AB6AXuC4_o9vuJcwTx1rPSyClWPVvS476d076Et1_W0-4sr6aktyUz-wZuLWv_3LQFRiv6ofb-uqSfoPih48FEGd3v-GEpDkM_5qiBUCzeTIEyIjRaAmXvOaOVtKTpzbrVwEF6vYBHzRJEkzbB5pfQhaxCXMJgVd0HSdgXu_Ot7Yzrhx2MtDfhMenfWm3CW-qfJpy51kUFzOforCme714gxdGznNQUP24Wt-hor8_yr75avUlpPIk0ioPkL9Vs2AHKmcSPAbu9qFDSogtU0X",
    imgH: "h-48",
  ...
  },
  {
    num: "05",
    title: "Awards Night",
    subtitle: "Winning moments",
    img: "https://lh3.googleusercontent.com/aida-public/AB6AXuCSBy5xWrCOIokNaRZqyO4l2I8yYFa1HCrxlH9pm0VM_jJiaTzfYUAebkIf__tY53q8ruj2NOegKkmFLDwriWC2of9l8k51cHYZgsm93T4uopCarUdP0T5zjmUhQvY3G-_dz9juMOda5kRouDiHcD0e3WDihdA5PlZU3KI058YmzPsF4OAbczkT3Q_nDAntwRegj0z_MXfqhEfQ6NnA0vx8w_yaUE_HgvJUMSZ9-rihxoNxx30GvtB5srFPKO-YplL09FReXM7w-jUn",
    imgH: "h-40",
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="relative w-full h-[1000px] md:h-[800px] px-4">
          ...
          {CARDS.map((c) => (
            <div
              key={c.num}
              className={`absolute ${c.pos} ${c.size} bg-light-blue rounded-2xl p-4 shadow-xl transform ${c.rotate} hover:rotate-0 hover:z-50 transition-all duration-300 ${c.z} group`}
            >
              ...
              <div
                className={`w-full ${c.imgH} bg-cover bg-center rounded-xl mb-4`}
                style={{ backgroundImage: `url('${c.img}')` }}
                role="img"
                aria-label={c.title}
              />
              <h3 className="font-heading text-xl font-bold text-navy mb-1 leading-tight">
                {c.title}
              </h3>
              <p className="text-primary text-sm font-medium">{c.subtitle}</p>
            </div>
          ))}
        </div>
      </div>
